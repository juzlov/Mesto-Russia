...
export default class Api {
  ...
  getNameFromServer() {
    fetch((`${this.serverUrl + this.options.baseUrl}/users/5176dd5ab8b6c044a17659a0`), {
      method: 'GET',
  ...
  changeAvatar() {
    fetch((`${this.serverUrl + this.options.baseUrl}users/5176dd5ab8b6c044a17659a0/avatar`), {
      method: 'PATCH',
      headers: this.options.headers,
      body: JSON.stringify({
